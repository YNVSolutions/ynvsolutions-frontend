    ...
    return (
        <>
            ...
            <div className='w-full min-h-screen flex flex-col lg:flex-row'> 
                <div className='w-full lg:w-[50%] bg-zinc-600 text-white text-4xl sm:text-5xl md:text-6xl font-semibold flex items-center justify-center'>
                    <img src='favicon.ico' className='h-48 w-48 sm:h-72 sm:w-72 md:h-96 md:w-96 rounded-lg mix-blend-multiply' alt="Logo" /> 
                </div>

                <div className='w-full lg:w-[50%] bg-zinc-900 p-4 sm:p-8 md:p-12 lg:p-36 flex items-center justify-center'>  
