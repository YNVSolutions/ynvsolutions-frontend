      ...
      <div className="w-full max-w-7xl bg-black/70 backdrop-blur-lg p-16 rounded-2xl shadow-2xl text-white flex flex-col md:flex-row gap-12 items-start justify-between">
        ...
        <form className="md:w-1/2 flex flex-col gap-5">
          <div className="relative">
            <input type="text" placeholder="Name" className="w-full p-3 pl-12 rounded-md bg-[#1a2238] text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 text-base" />
            <span className="absolute left-4 top-3 text-purple-300 text-lg">👤</span>
          </div>

          <div className="relative">
            <input type="email" placeholder="Email address" className="w-full p-3 pl-12 rounded-md bg-[#1a2238] text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 text-base" />
            <span className="absolute left-4 top-3 text-blue-300 text-lg">📧</span>
          </div>

          <div className="relative">
            <textarea rows="2" placeholder="How can we help you?" className="w-full p-3 pl-12 rounded-md bg-[#1a2238] text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 text-base"></textarea>
