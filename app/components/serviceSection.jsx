...
const ServiceSection = () => {
  ...
  return (
    <>
    <div className="container mx-auto px-6 text-center mb-15" id = 'services'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-4 lg:grid-rows-1 md:grid-cols-2 md:grid-rows-4 sm:grid-cols-1 sm:grid-rows-4 gap-4'>
        {data.map((element, idx) => (
          <div 
            key={idx} 
            className='bg-gradient-to-t from-gray-900/80 p-2 rounded-3xl  transform transition-transform duration-300 hover:scale-105 animate-float'
          >
