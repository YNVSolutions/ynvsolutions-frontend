  ...
  return (
    <>
      <div className="h-screen w-full pt-5 flex justify-center items-center">
        ...
        <div className='text-white absolute top-[20vh] left-[10vw] md:top-[15vh] md:left-[5vw] sm:top-[10vh] sm:left-[3vw]'>
          <h1 className='text-8xl font-bold md:text-6xl sm:text-4xl'>YNV Tech</h1>
          <h1 
            className='text-3xl text-white border-b-2 border-white font-semibold p-1 text md:text-2xl sm:text-xl' 
            style={{ display: 'inline-block' }}
          >
            Driving Digital Transformation Through Innovation
          </h1>
          <div className='w-[35vw] pt-4 md:w-[50vw] sm:w-[80vw]'>
